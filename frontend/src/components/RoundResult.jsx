  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden p-6">
      ...
      <div className="relative z-10 w-full max-w-2xl text-center">
        ...
        >
          {correct ? (
            <div className="flex flex-col items-center gap-4">
              ...
              >
                <CheckCircle className="w-24 h-24 text-[#4ecdc4]" strokeWidth={1.5} />
              </motion.div>
              <h2
            ...
            <div className="flex flex-col items-center gap-4">
              <XCircle className="w-24 h-24 text-[#ff6b35]" strokeWidth={1.5} />
              <h2
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <p
              ...
              style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '1.3rem', fontWeight: 500 }}
            >
              {location}
            </p>
          </div>
        ...
        >
          <div className="p-6 rounded-2xl bg-[#235a38]/40 backdrop-blur-md border border-[#4ecdc4]/20 space-y-3"
        ...
        >
          <h4
            ...
            style={{ fontFamily: "'Fredoka', sans-serif", fontSize: '1.3rem', fontWeight: 600 }}
          >
            Native Habitat Map
          </h4>

          <div className="relative rounded-2xl overflow-hidden border-2 border-[#4ecdc4]/30 max-w-md mx-auto"
               style={{
                 boxShadow: '0 12px 48px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(78, 205, 196, 0.1) inset'
               }}>
            <img
              src={mapImage}
